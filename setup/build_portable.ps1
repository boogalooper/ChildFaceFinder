...
Write-Host 'Creates a self-contained Windows x64 portable folder.'
...
try {
    ...
    Write-Host '[3/6] Copying application, models and managed Python...'
    ...
    Write-Host '[4/6] Installing packages into portable Python layout...'
    ...
    Write-Host '[5/6] Creating portable launchers and documentation...'
    $RunBat = @'
@echo off
...
'@
    ...
    Write-Host '[6/6] Validating portable runtime and GPU...'
    ...
    try {
        ...
        # This catches path/import/GPU problems before the portable folder is accepted.
    ...
    Write-Host 'Copy the entire ChildFaceFinder_Portable folder to the target PC.'
